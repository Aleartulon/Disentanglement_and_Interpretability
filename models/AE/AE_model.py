...
from models.AE.training_validation_functions import *
        ...
        if not self.checkpoint:
            ...
            for i in range(self.epochs):
                ...
                if i < self.warmup_lr: #use only AR
                    ...
                    if self.training_loss_coefficients['l_regularization'] >= max_regularization_coefficient:
                        self.training_loss_coefficients['l_regularization'] = max_regularization_coefficient
            ...
            for i in np.arange(start_epoch+1, self.epochs, 1):
                ...
                if valid_losses_data['total'] < loss_value: #careful valid loss tot!!
                    loss_value = valid_losses_data['total']
                    print('Models saved!')
                    save_checkpoint(self.encoder, self.decoder, optim, scheduler, i, loss_value , self.training_loss_coefficients['l_regularization'], full_training_count, self.PATH+'/checkpoint/check.pt')
                    early_stopping = 0
